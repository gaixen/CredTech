...
const LoginPage = () => {
  ...
  const inputFocusStyle = {
    ...
    boxShadow: "0 0 0 3px rgba(10, 218, 97, 0.1)",
  };
    ...
    <div style={containerStyle}>
      <div style={cardStyle}>
        ...
        <div style={contentStyle}>
          <h1 style={titleStyle}>CredTech</h1>
          <p style={subtitleStyle}>
            Welcome back to your credit intelligence platform
          </p>
          ...
          <div style={linkStyle}>
            ...
            <Link href="/register" style={linkHoverStyle}>
              Create one here
            </Link>
          </div>
        </div>
